sap.ui.require([
  ...
  var sViewName = "luigi.demo.persondetails.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "luigi.demo.persondetails"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title luigi.demo.persondetails"
            });
        }
      }
